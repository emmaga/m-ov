...
(function () {
    var app = angular.module('app.directive', [])
        ...
        .directive("shopCartBall", function () {
            return {
                restrict: 'EA',
                templateUrl: 'pages/drt/shop-cart-ball.html',
                replace: true
            }
        })

        .controller('shopCartBallController', ['$scope', '$filter', '$timeout',
            function ($scope, $filter, $timeout) {
                var self = this;
                self.balls = [
                    {
                ...
                self.drop = function (e) {
                    var top = window.innerHeight - 43;
                    var left = window.innerWidth - 120;
                    for (var i = 0; i < self.balls.length; i++) {
                        ...
                        if (!ball.show) {
                            ...
                            ball.innerstyle = {
                                ...
                                'transition':'transform .5s cubic-bezier(.29,.01,.49,.17)'
                            }
                            $timeout(function () {
                                ball.show = false
                                ball.style = ''
